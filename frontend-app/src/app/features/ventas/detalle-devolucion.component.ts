    ...
    <div class="container-fluid py-4 px-4">
      ...
      <div class="d-flex align-items-center gap-3 mb-4 flex-wrap">
        ...
        <div class="flex-grow-1">
          <h3 class="mb-0"><i class="bi bi-arrow-return-left me-2 text-danger"></i>Detalle de Devolución</h3>
      ...
      <div *ngIf="!loading() && data()">
          ...
          <div class="card-body">
            <div class="row g-3">
              ...
              <div class="col-md-1 text-end">
                ...
                <div class="fw-bold text-danger">\${{ data().documento?.valor_neto | number:'1.0-0' }}</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div *ngIf="!data().lineas?.length" class="text-center py-5 text-muted">
          ...
          <p class="mt-2">Esta devolución no tiene líneas</p>
        </div>
      </div>
    </div>
  `
...
export class DetalleDevolucionComponent implements OnInit {
  ...
  exportarCsv() {
    ...
    a.href = url;
    a.download = `devolucion_${doc?.consecutivo || 'detalle'}.csv`;
    a.click();
