    ...
    <div class="container-fluid py-4 px-4">
      ...
      <div class="d-flex align-items-center gap-3 mb-4 flex-wrap">
        ...
        <div class="flex-grow-1">
          <h3 class="mb-0"><i class="bi bi-bag me-2 text-success"></i>Detalle de Pedido</h3>
      ...
      <div *ngIf="!loading() && data()">
          ...
          <div class="card-body">
            <div class="row g-3">
              ...
              <div class="col-md-1 text-end">
                ...
                <div class="fw-bold text-success">\${{ data().documento?.valor_neto | number:'1.0-0' }}</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div *ngIf="!data().lineas?.length" class="text-center py-5 text-muted">
          ...
          <p class="mt-2">Este pedido no tiene líneas</p>
        </div>
      </div>
    </div>
  `
...
export class DetallePedidoComponent implements OnInit {
  ...
  exportarCsv() {
    ...
    a.href = url;
    a.download = `pedido_${doc?.consecutivo || 'detalle'}.csv`;
    a.click();
